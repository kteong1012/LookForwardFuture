...
namespace RenderHeads.Media.AVProVideo.Demos
{
	...
	public class VCR : MonoBehaviour 
	{
        ...
        {
            LoadingPlayer.m_VideoPath =_videoFiles[index];
            _VideoIndex = index % (_videoFiles.Length);
		...
		public void OnOpenVideoFile()
        {
            ...
            LoadingPlayer.m_VideoPath = _videoFiles[_VideoIndex];
			if (string.IsNullOrEmpty(LoadingPlayer.m_VideoPath))
			{
				LoadingPlayer.CloseVideo();
				_VideoIndex = 0;
...
//				SetButtonEnabled( "PauseButton", true );
        ...
        public void Back()
        {
            VideoPlayerManager.Instance.Back();
        }
